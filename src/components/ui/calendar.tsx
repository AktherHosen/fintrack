  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        weekday:
          'text-zinc-400 dark:text-zinc-500 font-semibold text-[10px] uppercase tracking-wider h-6 flex items-center justify-center',
        ...
        today:
          'border border-indigo-500/50 font-bold text-indigo-600 dark:text-indigo-400 bg-indigo-50/60 dark:bg-indigo-950/40',
        outside: 'text-zinc-400 dark:text-zinc-600 opacity-40 hover:opacity-80',
        disabled:
          'text-zinc-300 dark:text-zinc-700 opacity-30 cursor-not-allowed pointer-events-none',
        range_start: 'rounded-l-lg bg-indigo-600 text-white',
        range_end: 'rounded-r-lg bg-indigo-600 text-white',
        range_middle:
          'bg-indigo-50 dark:bg-indigo-950/40 text-indigo-700 dark:text-indigo-300 rounded-none',

        // Backward compatibility v8 classnames
        caption: 'flex justify-center pt-1 relative items-center h-8 mb-1 w-full',
        nav_button:
          'h-7 w-7 inline-flex items-center justify-center rounded-lg border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 text-zinc-600 dark:text-zinc-400',
