...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      "border-b border-zinc-800/80 transition-colors hover:bg-zinc-900/50 data-[state=selected]:bg-zinc-800",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "h-10 px-4 text-left align-middle font-semibold text-xs text-zinc-400 [&:has([role=checkbox])]:pr-0",
      className
    )}
    {...props}
  />
