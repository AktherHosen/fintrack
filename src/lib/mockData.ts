...
export const INITIAL_BANNERS: Banner[] = [
  ...
  },
  {
    ...
    description:
      'Easily track money lent to friends or borrowed funds with instant calculation of outstanding balances.',
    link_url: '/loans',
  ...
  },
  {
    ...
    description:
      'Monitor daily MFS limits and categorize every send-money / payment transaction with one tap.',
    link_url: '/accounts',
  ...
  {
    id: 'bnr-4',
    title: '📊 Smart Monthly Budget & Overspend Notifications',
    description:
      'Stay on track with real-time budget threshold warnings and category spending breakdowns.',
    link_url: '/budgets',
    button_text: 'Set Budgets',
    type: 'FEATURE',
    position: 'ALL_PAGES',
    target_audience: 'ALL',
    priority: 4,
    is_active: true,
    background_color: 'linear-gradient(135deg, #1e293b 0%, #334155 50%, #475569 100%)',
    text_color: '#ffffff',
