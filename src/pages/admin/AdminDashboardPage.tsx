      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <Card className="p-5 border-indigo-500/30 bg-indigo-50/50 dark:bg-gradient-to-br dark:from-zinc-900 dark:via-zinc-900 dark:to-indigo-950/20 shadow-xs hover:border-indigo-500/50 transition-all">
          ...
          {pendingPaymentsCount > 0 ? (
            ...
            <span className="text-[11px] text-zinc-500 dark:text-zinc-400 mt-3 block">
              All clear
            </span>
          )}
        </Card>
        ...
        <Card className="p-5 border-indigo-500/30 bg-indigo-50/50 dark:bg-gradient-to-br dark:from-zinc-900 dark:via-zinc-900 dark:to-indigo-950/20 shadow-xs hover:border-indigo-500/50 transition-all">
          <div className="flex items-center justify-between">
            <div>
              ...
              <h3 className="text-2xl font-black text-indigo-600 dark:text-indigo-300 mt-1">
          ...
          <Link
            to="/admin/banners"
            className="text-xs text-indigo-600 dark:text-indigo-400 hover:underline mt-3 flex items-center gap-1 font-medium"
          >
